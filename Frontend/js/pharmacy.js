...
async function loadInventory() {
    ...
    try {
        const response = await authenticatedFetch('/pharmacy/inventory');
...
function displayInventory(items) {
    ...
    if (items.length === 0) {
        tableBody.innerHTML = '<tr><td colspan="6" class="text-center">No items found. Add your first item!</td></tr>';
        return;
    }
